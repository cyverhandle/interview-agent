...
// Official challenge data (curriculum.json). Used both by the interview engine
// (to ground questions in what a candidate has actually covered) and by the
// UI (module grid, day chips, progress).
// ---------------------------------------------------------------------------
...
export interface CurriculumDay {
  ...
  objectives: string[];
  tools: string[];
  /** day category: SETUP / BUILD / AI_CORE / LEARN / SHIP_IT / OPTIMIZE / CAPSTONE */
  type?: string;
}
...
export const MODULES: CurriculumModule[] = [
  {
    ...
    days: [1, 3],
    focus: "Dev environment, local LLMs and the first AI project",
  },
  {
    id: "data-foundations",
    name: "Data Foundations",
    days: [4, 6],
    focus: "Structured, unstructured and knowledge-base processing",
  },
  {
    id: "embeddings-vector",
    name: "Embeddings & Vector Search",
    days: [7, 10],
    focus: "Embeddings, vector databases and the retrieval engine",
  },
  {
    id: "llm-prompting",
    name: "LLM Core, Prompting & Fine-Tuning",
    days: [11, 15],
    focus: "RAG pipelines, prompt engineering and fine-tuning",
  },
  {
    id: "chatbot-build",
    name: "Chatbot Application Build",
    days: [16, 20],
    focus: "Backend, frontend, streaming and conversation memory",
  },
  {
    id: "agents-mcp",
    name: "Agentic AI & MCP",
    days: [21, 24],
    focus: "Agents, orchestration, MCP and agentic integration",
  },
  {
    id: "eval-security",
    name: "Evaluation, Security & Deployment",
    days: [25, 28],
    focus: "Testing, optimization, security and container deployment",
  },
  {
    id: "production-capstone",
    name: "Production & Capstone",
    days: [29, 31],
    focus: "Observability, production readiness and the capstone demo",
  },
];
